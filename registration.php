            ...
            <div class="row main">
                ...
                <div class="main-login main-center">
                    <form class="form-horizontal" method="post" action="registration.php">
                        ...
                        <div class="form-group">
                            <label for="confirm" class="cols-sm-2 control-label" name="confirm" required>Confirm Password</label>
                            <div class="cols-sm-10">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
                        ...
                        <div class="form-group ">
                            <button type="submit" button onclick='foo();' class="btn btn-primary btn-lg btn-block login-button" name="reg_btn">Register</button>
                            <script>
                        function foo(){
